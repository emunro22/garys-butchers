    ...
    <div>
      ...
      <section className="bg-cream-50 py-16 md:py-20">
        <div className="mx-auto max-w-3xl px-4 md:px-8">
          ...
          <ul className="space-y-2 text-ink-700">
            <li>Free delivery is available within 5 miles of the shop. Otherwise, between 5 and 10 miles, a delivery fee of £3.95 applies. Beyond 10 miles (up to our 30 mile delivery radius), a £5 delivery charge applies.</li>
