...
const ProductSchema = z.object({
  ...
  cookingTips: z.string().max(4000).optional().nullable(),
  ...
  variants: z.array(z.object({
    ...
    priceInPence: z.number().int().min(0),
    compareAtPriceInPence: z.number().int().min(0).optional(),
  })).optional(),
  ...
  showOnOffers: z.boolean().optional(),
  ...
  try {
    ...
    const [created] = await catalogDb
      ...
      .values({
        ...
        showOnOffers: data.showOnOffers ?? false,
