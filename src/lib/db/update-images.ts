/**
 * Assigns product-specific stock Unsplash images to every product.
 * Safe to re-run — will overwrite generic category-level fallback images.
 *
 * Run with:  npm run db:images
 *
 * To use a custom photo instead, upload it via Admin → Products → edit product.
 */
